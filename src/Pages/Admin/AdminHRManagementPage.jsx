    ...
    try {
      ...
      const formattedRequests = transformedData.map(leave => ({
        ...
        employee: {
          ...
          name: `Employee ID: ${leave.employeeId}`,
          email: 'N/A',
          phone: 'N/A',
          department: 'N/A',
          position: 'N/A'
  ...
  const processRequest = async (action) => {
    try {
      ...
      if (selectedRequest.type === "HR Complaint/Feedback") {
        ...
        console.log('Sending complaint update:', { type, description, status });
      ...
      try {
        ...
        const formattedLeaves = Array.isArray(leaveRes.data) ? leaveRes.data.map(leave => ({
          ...
          employee: {
            ...
            name: leave.employee ? `${leave.employee.firstName} ${leave.employee.lastName}` : `Employee ID: ${leave.employeeId}`,
        ...
        const formattedComplaints = Array.isArray(complaintsRes.data) ? complaintsRes.data.map(complaint => ({
          ...
          employee: {
            ...
            name: `Employee ID: ${complaint.employeeId}`,
            email: 'N/A',
            phone: 'N/A',
            department: 'N/A',
            position: 'N/A'
                        ...
                        <div className="table-actions">
                          ...
                          {req.status === "Pending" && (
                            <>
                              ...
                              {/* <button 
                                className="btn-action in-progress-btn"
                                onClick={() => handleAction(req, "inProgress")}
                              >
                                In Progress
                              </button> */}
                            </>
