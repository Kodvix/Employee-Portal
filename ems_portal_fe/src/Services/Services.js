...
export const  getCompanyId  = (id , companyData) =>axios.get(`http://192.168.1.19:8080/api/companies/${id}` ,companyData);

export const getProjectId = (id, projectData) => axios.get(`http://192.168.1.19:8080/api/projects/${id}`, projectData);
// Task APIs
