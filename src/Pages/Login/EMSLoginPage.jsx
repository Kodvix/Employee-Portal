...
//       setupTokenExpirationMonitor(token);
...
//         localStorage.removeItem('authToken');
//         localStorage.removeItem('userRole');
//         setLoginError(`Access denied. Your account does not have ${userType[0]} privileges.`);
//       }
...
//   const setupTokenExpirationMonitor = (token) => {
//     try {
//       const payload = JSON.parse(atob(token.split('.')[1]));
...
//       }
//     } catch (error) {
//       console.error("Error setting up token expiration monitor:", error);
//       handleLogout();
//     }
//   };
...
//       if (result.success) {
//         console.log("Login successful, Employee ID:", result.employeeId);
