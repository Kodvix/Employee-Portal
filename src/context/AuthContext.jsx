...
//       if ((selectedRole === "ADMIN" && apiRole === "ADMIN") ||
//           (selectedRole === "EMPLOYEE" && apiRole === "EMPLOYEE")) {
//          // Fetch employee data using email to get employeeId
//       const empRes = await axios.get(
//         `http://localhost:8080/api/employee/email/${encodeURIComponent(email)}`
//       );

//       const employeeId = empRes.data.employeeId;
//         // Store user info
//         localStorage.setItem("authToken", token);
//         localStorage.setItem("userRole", role);
//         localStorage.setItem("user", JSON.stringify({ ...user, employeeId }));
...
//         return { success: true, role: apiRole };
//       } else {
//         return { 
//           success: false, 
...
//             setIsAuthenticated(true);
//             setUserRole(role);
//             setEmployeeId(empId ? parseInt(empId) : null);
//             setCurrentUser(user ? JSON.parse(user) : null);
...
//         return { success: true, role: apiRole, employeeId: empId };
//       } else {
//         return { 
//           success: false, 
//           error: `Access denied. Your account does not have ${selectedRole.toLowerCase()} privileges.` 
