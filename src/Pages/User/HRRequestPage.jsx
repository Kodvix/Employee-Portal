...
const BASE_URL = 'http://192.168.1.32:8080/api/complaints';
...
const createComplaint = async (complaintData) => {
  try {
    ...
    const response = await axios.post("http://192.168.1.32:8080/api/complaints", formData, {
      headers: {
...
const createLeaveRequest = async (leaveData, employeeId) => {
  try {
    ...
    const response = await axios.post(`http://192.168.1.32:8080/api/leaves/${employeeId}`, formData, {
      headers: {
        'Content-Type': 'multipart/form-data'
      }
    });
...
const getLeaveRequestById = async (id) => {
  try {
    const response = await axios.get(`http://192.168.1.32:8080/api/leaves/${id}`);
    console.log(response.data);
    return response.data;
  } catch (error) {
...
const getLeaveRequestsByEmployeeId = async (employeeId) => {
  try {
    const response = await axios.get(`http://192.168.1.32:8080/api/leaves/employee/${employeeId}`, {
      headers: {
...
const deleteLeaveRequest = async (id) => {
  try {
    const response = await axios.delete(`http://192.168.1.32:8080/api/leaves/${id}`);
    console.log(response.data);
    return response.data;
  } catch (error) {
...
const getHolidays = async () => {
  try {
    const response = await axios.get('http://192.168.1.32:8080/api/holiday/', {
      headers: {
        'Content-Type': 'application/json',
        'Accept': '*/*'
      }
