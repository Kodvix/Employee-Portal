...
const AdminHRManagementPage = () => {
  ...
  const fetchLeaveRequests = async () => {
    try {
      ...
      const response = await axios.get("http://192.168.1.19:8080/api/leaves", {
        headers: {
  ...
  const processLeaveRequest = async (leaveId, action, remarks) => {
    try {
      ...
      const response = await axios.get(`http://192.168.1.19:8080/api/leaves/${leaveId}`, {
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json'
        }
      ...
      await axios.put(`http://192.168.1.19:8080/api/leaves/${leaveId}`, formData, {
        headers: {
  ...
  const deleteLeaveRequest = async (leaveId) => {
    try {
      ...
      await axios.delete(`http://192.168.1.19:8080/api/leaves/${leaveId}`);
  ...
  const deleteComplaint = async (complaintId) => {
    try {
      ...
      await axios.delete(`http://192.168.1.19:8080/api/complaints/${complaintId}`);
  ...
  const processRequest = async (action) => {
    ...
    try {
      ...
      if (selectedRequest.type === "HR Complaint/Feedback") {
        ...
        const response = await axios.get(`http://192.168.1.19:8080/api/complaints/${selectedRequest.id}`);
        ...
        const updateResponse = await axios.put(
          `http://192.168.1.19:8080/api/complaints/${selectedRequest.id}?type=${encodeURIComponent(type)}&description=${encodeURIComponent(description)}&status=${encodeURIComponent(newStatus)}`,
          formData,
          {
            headers: {
              'Content-Type': 'multipart/form-data',
        ...
        const response = await axios.get(`http://192.168.1.19:8080/api/leaves/${selectedRequest.id}`);
        const currentLeave = response.data;
        ...
        const updateResponse = await axios.put(
          `http://192.168.1.19:8080/api/leaves/${selectedRequest.id}`,
          formData,
          {
            headers: {
              'Content-Type': 'multipart/form-data'
  ...
  useEffect(() => {
    const fetchAllRequests = async () => {
      try {
        ...
        const leaveRes = await axios.get("http://192.168.1.19:8080/api/leaves/", {
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
          }
    ...
    `Employee ID: ${leave.employeeId}`,
        ...
        const complaintsRes = await axios.get("http://192.168.1.19:8080/api/complaints", {
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
          }
  ...
  const createComplaint = async (complaintData) => {
    try {
      ...
      const response = await axios.post("http://192.168.1.19:8080/api/complaints", complaint, {
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json'
        }
  ...
  const updateComplaint = async (id, complaintData) => {
    try {
      const currentComplaint = await axios.get(`http://192.168.1.19:8080/api/complaints/${id}`);
      ...
      const response = await axios.put(`http://192.168.1.19:8080/api/complaints/${id}`, updatedComplaint, {
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json'
        }
