...
const AdminHolidayPage = () => {
  ...
  const handleAddHoliday = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://192.168.1.19:8080/api/holiday/save', formData);
  ...
  const handleEditHoliday = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(`http://192.168.1.19:8080/api/holiday/save`, {
        ...formData,
  ...
  const handleDeleteHoliday = async (holidayId) => {
    if (window.confirm('Are you sure you want to delete this holiday?')) {
      try {
        await axios.delete(`http://192.168.1.19:8080/api/holiday?holidayId=${holidayId}`);
